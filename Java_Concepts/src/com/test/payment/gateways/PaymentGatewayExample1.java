package com.test.payment.gateways;
...
public class PaymentGatewayExample1 {
    ...
    public static void main (String args[]) {
    	...
    	//Note: below line throughs compilation error so changed JRE System Library to Default,error gone
